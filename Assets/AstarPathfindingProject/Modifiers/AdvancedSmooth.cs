	...
	public class AdvancedSmooth : MonoModifier {
		...
		public class MaxTurn : TurnConstructor {
			...
			public override void OnTangentUpdate () {
				//Debug.Log ("Updating Changed Tangent");
				...
				//DebugCircle (rightCircleCenter,turningRadius,new Color (1,0,0,0.4F));
				//DebugCircle (leftCircleCenter,turningRadius,new Color (1,0,0,0.4F));
			}
			...
			public override void Prepare (int i, Vector3[] vectorPath) {
				...
				//Debug.DrawLine (rightCircleCenter,leftCircleCenter,Color.cyan);
			...
			public override void TangentToTangent (List<Turn> turnList) {
				...
				//Debug.DrawLine (pRightRight1, pRightRight2, Color.black);
				//Debug.DrawLine (pRightLeft1, pRightLeft2, Color.magenta);
				//Debug.DrawLine (pLeftRight1, pLeftRight2, Color.cyan);
				//Debug.DrawLine (pLeftLeft1, pLeftLeft2, Color.blue);
				...
				/*Debug.Log ("=== Turn Distances ==="
				           +"\nRight - Right:	"+betaRightRight
				           +"\nRight - Left :	"+betaRightLeft
			...
			public override void PointToTangent (List<Turn> turnList) {
				...
				//Debug.Log ("=== "+delta+" "+gammaRight+" Turning Rad "+turningRadius);
				//Debug.DrawLine (rightCircleCenter+ AngleToVector (gammaRight)*turningRadius, rightCircleCenter, Color.green);
		...
		public class ConstantTurn : TurnConstructor {
			...
			public override void GetPath (Turn turn, List<Vector3> output) {
				...
				//Debug.DrawLine (current,current+t2*5,Color.cyan);
			}
		}
		...
		public struct Turn : IComparable<Turn> {
			...
			public int CompareTo (Turn t) {
				//Debug.Log ("Comparing "+t.id+" with "+id+" - scores "+t.score+" and "+score);
